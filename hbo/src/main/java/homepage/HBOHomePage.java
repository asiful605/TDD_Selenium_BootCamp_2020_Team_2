...
public class HBOHomePage extends WebAPI {
    ...
    public void chooseHBOPlan() {
        HBOPlan.click();
    }
    public void getInSignInPage() {
        signInPage.click();
    }
    ...
    public void chooseDocumentaries(){
        documentaries.click();
    }
    public void selectSeries(){
        series.click();
    }
    public void chooseAllSeries(){
        allSeries.click();
    }
    public void selectSpecials(){
        specials.click();
    }
    public void chooseAllSpecials(){
        allSpecials.click();
    }
    public void selectKids(){
        kids.click();
    }
    public void chooseRoy(){
        roy.click();
    }
    public void selectSports(){
        sports.click();
    }
    public void chooseALLSports(){
        allSports.click();
    }
